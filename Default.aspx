...
<body>
    ...
    <div id="top" style="background-color: #00FFFF">
    
        <asp:Image ID="Image1" runat="server" ImageUrl="~/ot.jpg" Height="121px" Width="1000px" />
    ...
    <div id="left">
    <div id="stulogin">
        <table class="tbl" style="background-color: #00FFFF">
            <tr>
                <td>
                    &nbsp;</td>
                <td>
        ...
        </div><div id="stafflogin" style="background-color: #00FFFF">
            <table class="tbl">
                <tr>
	...
	<div class="ws_images">
<a href="#"><img src="data1/images/im1.jpg" alt="" title="" id="wows0" class="auto-style2"/></a>
<a href="#"><img src="data1/images/im2.jpg" alt="" title="" id="wows1"class="auto-style2"/></a>
<a href="#"><img src="data1/images/im3.jpg" alt="" title="" id="wows2"class="auto-style2"/></a>
<a href="#"><img src="data1/images/im4.jpg" alt="" title="" id="wows3"class="auto-style2"/></a>
<a href="#"><img src="data1/images/im5.jpg" alt="" title="" id="wows4"class="auto-style2"/></a>
<a href="#"><img src="data1/images/im6.jpg" alt="" title="" id="wows5"class="auto-style2"/></a>
<a href="#"><img src="data1/images/im7.jpg" alt="" title="" id="wows6"class="auto-style2"/></a>
</div>
<div class="ws_bullets"><div>
<a href="#wows0" title=""><img src="data1/tooltips/im1.jpg" alt=""/>1</a>
<a href="#wows1" title=""><img src="data1/tooltips/im2.jpg" alt=""/>2</a>
<a href="#wows2" title=""><img src="data1/tooltips/im3.jpg" alt=""/>3</a>
<a href="#wows3" title=""><img src="data1/tooltips/im4.jpg" alt=""/>4</a>
<a href="#wows4" title=""><img src="data1/tooltips/im5.jpg" alt=""/>5</a>
<a href="#wows5" title=""><img src="data1/tooltips/im6.jpg" alt=""/>6</a>
<a href="#wows6" title=""><img src="data1/tooltips/im7.jpg" alt=""/>7</a>
</div></div>
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="log"> Learn Every Things at One Place</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; font-size:20px; text-align: center; vertical-align: middle;">Smart Way To Gain Knowledge </div>
    </form>
</body>
</html>
